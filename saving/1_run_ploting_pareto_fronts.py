...
def main():
    ...
    with Semaphore(1) as sem:
        ...
        for algo in participants:
            ...
            if algo == "qnehvi":
                file_path = 'your-path-to/Saving/qnehvi/DeFiNES_SSS_os_ALGO_qNEHVI_TIME__02_13_15_55_imagenet_/train_output.csv'
                df = pd.read_csv(file_path, header=None)
                plt_color = "green"
            elif algo == "qnpargeo":
                file_path = 'your-path-to/Saving/qnpargeo/DeFiNES_SSS_os_ALGO_qNParEGO_TIME__02_09_20_01_imagenet_/train_output.csv'
                df = pd.read_csv(file_path, header=None)
                plt_color = "red"
            elif algo == "coflex":
                file_path = 'your-path-to/Saving/coflex_gen_2/DeFiNES_SSS_os_ALGO_Coflex_TIME__02_07_13_31_imagenet_/train_output.csv'
                df = pd.read_csv(file_path, header=None)
                plt_color = "blue"
            elif algo == "qehvi":
                file_path = 'your-path-to/Saving/qehvi/DeFiNES_SSS_os_ALGO_qEHVI_TIME__02_15_09_54_imagenet_/train_output.csv'
                df = pd.read_csv(file_path, header=None)
                plt_color = "orange"
            elif algo == "nsga":
                file_path = ''
                ...
                file_path = 'your-path-to/Saving/pabo/DeFiNES_SSS_os_ALGO_pabo_TIME__03_03_10_25_imagenet_/train_output.csv'
                df = pd.read_csv(file_path, header=None)
                plt_color = "grey"
            elif algo == "random":
                file_path = 'your-path-to/Saving/random/DeFiNES_SSS_os_ALGO_random_TIME__02_16_01_17_imagenet_/train_output.csv'
                df = pd.read_csv(file_path, header=None)
                plt_color = "grey"
